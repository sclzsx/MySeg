...
class Encoder(nn.Module):
    def __init__(self, divisor):
        ...
        groups = 4
        planes = [32 // divisor, 64 // divisor, 128 // divisor]
        ...
        self.downSampling2 = DownSampling(in_channels=32//divisor, out_channels=planes[1])
...
class LEDnet2(nn.Module):
    def __init__(self, num_classes=20, divisor=1):
        super(LEDnet2, self).__init__()
        self.encoder = Encoder(divisor=divisor)
        self.decoder = Decoder(in_channels=128 // divisor, num_classes=num_classes)
...
#     model = LEDnet(num_classes=2)
#     print(model)
#     input = torch.randn(1, 3, 528, 960)
#     output = model(input)
#     print(output.shape)
if __name__ == '__main__':
