...
class UpsamplingBottleneck_sx(nn.Module):
...
class LANENet(nn.Module):
    def __init__(self, num_classes=2):
        ...
        #     nn.ConvTranspose2d(32, 5, kernel_size=2, stride=2, padding=0, bias=True),
        # )
        #
        # self.classifier = nn.Conv2d(32, 5, kernel_size=1)
        # self.fc_input_feature = 5 * int(256 / 8) * int(128 / 8)

        self.deconv3 = nn.Sequential(nn.ConvTranspose2d(32, 2, kernel_size=2, stride=2, padding=0, bias=True), )
        self.classifier = nn.Conv2d(32, 2, kernel_size=1)
        self.fc_input_feature = 2 * int(256 / 8) * int(128 / 8)
...
class LANENet_deconv(nn.Module):
    def __init__(self, num_classes=2):
        super(LANENet_deconv, self).__init__()
        ...
        # Stage 4_1 - Decoder
        self.upsample4_0_1 = UpsamplingBottleneck_sx(64, 32, padding=1, dropout_prob=0.1, relu=False)
        self.regular4_1_1 = RegularBottleneck(32, padding=1, dropout_prob=0.1, relu=False)
        self.regular4_2_1 = RegularBottleneck(32, padding=1, dropout_prob=0.1, relu=False)
