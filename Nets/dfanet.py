...
if __name__ == '__main__':
    ...
    #           [240, 144, 288],
    #           [240, 144, 288]]
    # net = DFANet(ch_cfg, 64, num_classes=2).cuda()

    ch_cfg = [[8//divisor, 48//divisor, 96//divisor],
              [240//divisor, 144//divisor, 288//divisor],
              [240//divisor, 144//divisor, 288//divisor]]
    net = DFANet(ch_cfg, 64//divisor, num_classes=2).cuda()
